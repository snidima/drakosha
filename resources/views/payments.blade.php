        ...
        <ol class="payments block">
            <li class="payments-big">
                <p>
                    ...
                    вашем <a href="{{route('user')}}">Личном кабинете</a> <b>выбираете файл и загружаете сканированную копию чека.
                    Только после этого заявка будет отправлена!</b>
                </p>
            </li>
            <li class="payments-big">
                <p>
                    Оплатить онлайн без комиссии через: <b>Visa/MasterCard, QIWI, Яндекс.Деньги, Сбербанк-Онлайн.</b><br>
                    Сделать это можно во втором шаге вашего
                    личного кабинета.
                </p>
            </li>
        </ol>
